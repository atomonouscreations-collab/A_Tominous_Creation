...
No outside capital going in — funding this through open-source-native routes, in rough order of effort. Since this is more a software project than a hardware one, several of these are a better fit than they'd be for a pure hardware build.

## 1. Public build log 

- [ ] Create GitHub repo, push this scaffold
- [ ] Create hackaday.io project page
- [ ] First post: the concept + the "why open source, not patented" framing
- [ ] Post design updates as they happen, not just at milestones — reviewers and backers on every platform below are evaluating the log, not a pitch deck

## 2. Free exposure / prize money
...
- [ ] SBIR/STTR (NSF/DOE) — non-dilutive; heavier application, worth keeping in back pocket once there's a working prototype
